...
if ( ! is_user_logged_in() ) {
	...
	wp_die(
		__( 'You must be logged in to run this script.', 'toolbar-extras-oxygen' ),
		__( 'Toolbar Extras for Oxygen', 'toolbar-extras-oxygen' ),
...
if ( ! current_user_can( 'install_plugins' ) ) {
	...
	wp_die(
		__( 'You do not have permission to run this script.', 'toolbar-extras-oxygen' ),
		__( 'Toolbar Extras for Oxygen', 'toolbar-extras-oxygen' ),
		array( 'back_link' => TRUE )
	);
...
if ( function_exists( 'is_multisite' ) && is_multisite() ) {
	...
	if ( function_exists( 'get_sites' ) && class_exists( 'WP_Site_Query' ) ) {
		...
		foreach ( $site_ids as $site_id ) {
			...
			ddw_tbexob_delete_options_transients();
