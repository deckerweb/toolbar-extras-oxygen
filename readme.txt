=== Toolbar Extras for Oxygen Builder - Power Up Your Admin Bar ===
...
Technically Oxygen Builder is not required. However, without Oxygen Builder being activated this Add-On plugin (Toolbar Extras for Oxygen Builder) doesn't make any sense at all. That means, without Oxygen active, no items, settings etc. will be loaded at all.
